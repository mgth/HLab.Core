...
public partial struct Matrix: IFormattable
{
        ...
        public override bool Equals(object? o) => o is Matrix value && Equals(this,value);
        ...
        public bool Equals(Matrix value) => Equals(this, value);
        ...
        internal string ConvertToString(string format, IFormatProvider provider)
        {
            ...
            const char separator = ','; //MS.Internal.TokenizerHelper.GetNumericListSeparator(provider);
    ...
    public Point Transform(Point point) => MultiplyPoint(point);
    ...
    public void Transform(Point[] points)
    {
       ...
       {
          points[i] = MultiplyPoint(points[i]);
       }
    }
    ...
    public Vector Transform(Vector vector) => MultiplyVector(vector);
        ...
        get
        {
           return _type switch
           {
              ...
              MatrixTypes.TRANSFORM_IS_SCALING
                 or (MatrixTypes.TRANSFORM_IS_SCALING | MatrixTypes.TRANSFORM_IS_TRANSLATION) => (_m11  * _m22),
    ...
    internal Vector MultiplyVector(Vector v)
    {
       return _type switch
       {
          MatrixTypes.TRANSFORM_IS_IDENTITY or MatrixTypes.TRANSFORM_IS_TRANSLATION => v,
          MatrixTypes.TRANSFORM_IS_SCALING or (MatrixTypes.TRANSFORM_IS_SCALING | MatrixTypes.TRANSFORM_IS_TRANSLATION)
             => new(v.X * _m11, v.Y * _m22),
          _ => new(v.X * _m11 + v.Y * _m21, v.Y * _m22 + v.X * _m12)
       };
    }
    ...
    /// MultiplyPoint
    /// </summary>
    internal Point MultiplyPoint(Point p)
    {
       return _type switch
       {
          MatrixTypes.TRANSFORM_IS_IDENTITY => p,
          MatrixTypes.TRANSFORM_IS_TRANSLATION => p.Offset(_offsetX, _offsetY),
          MatrixTypes.TRANSFORM_IS_SCALING => new Point(p.X * _m11, p.Y * _m22),
          MatrixTypes.TRANSFORM_IS_SCALING | MatrixTypes.TRANSFORM_IS_TRANSLATION => new Point(p.X * _m11 + OffsetX,
             p.Y * _m22 + _offsetY),
          _ => new Point(p.X * _m11 + p.Y * _m21 + _offsetX, p.Y * _m22 + p.X * _m12 + _offsetY)
       };
    }
